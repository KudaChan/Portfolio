    ...
    return (
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                ...
                <Card
                    title="Launch, Optimization & Maintenance "
...
const Card = ({
    ...
    return (
        ...
        >
            <Icon className="absolute h-8 w-8 -top-1 -left-1 dark:text-white text-black opacity-30" />
            <Icon className="absolute h-8 w-8  -bottom-1 -left-1 dark:text-white text-black opacity-30" />
            <Icon className="absolute h-8 w-8  -top-1 -right-1 dark:text-white text-black opacity-30" />
            <Icon className="absolute h-8 w-8  -bottom-1 -right-1 dark:text-white text-black opacity-30" />
            ...
            <div className="relative z-20 px-10">
                ...
                <p
                    className="text-sm opacity-0 group-hover/canvas-card:opacity-100 relative z-10 mt-4 group-hover/canvas-card:text-white text-justify group-hover/canvas-card:-translate-y-2 transition duration-200"
                    style={{ color: "#E4ECFF" }}
                >
                    {des}
                </p>
