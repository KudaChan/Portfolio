"""_summary_
This is the implementation of VGG16 model.
"""
...
class VGGModel:
    ...
    def train_model(self, x_train, y_train, x_test, y_test):
        ...
        checkpoint = ModelCheckpoint(
            f'VGG16_{self.processed_data_type}.keras', monitor='val_loss', verbose=1, save_best_only=True)
        ...
        name = f"VGG16_model_accuracy_loss_{
